    ...
    return (
        ...
        <div className="flex flex-col md:flex-row py-16 max-w-6xl w-full px-6 mx-auto">
            <div className="flex-1 max-w-4xl">
                    ...
                    <div key={index} className="grid grid-cols-[2fr_1fr_1fr] text-gray-500 items-center text-sm md:text-base font-medium pt-3">
                        <div className="flex items-center md:gap-6 gap-3">
                            <div className="cursor-pointer w-24 h-24 flex items-center justify-center border border-gray-300 rounded">
                                <img className="max-w-full h-full object-cover" src={product.product_image} alt={product.name} />
                            </div>
                            <div>
                                <p className="hidden md:block font-semibold">{product.category}</p>
                        ...
                        <button className="cursor-pointer mx-auto" onClick={() => handleRemoveProduct(index)}>
                ...
                <Link to={'/'}>
                <button className="group cursor-pointer flex items-center mt-8 gap-2 text-orange-500 font-medium">
            ...
            <div className="max-w-[360px] w-full bg-gray-100/40 p-5 max-md:mt-16 border border-gray-300/70">
                ...
                <button onClick={handlePlaceOrder} className="w-full py-3 mt-6 cursor-pointer bg-orange-500 text-white font-medium hover:bg-orange-600 transition">
                    Place Order
                </button>
            </div>
        </div>
